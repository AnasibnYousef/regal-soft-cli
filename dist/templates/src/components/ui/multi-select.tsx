...
const multiSelectVariants = cva(
  "m-1 transition ease-in-out duration-300 rounded-md",
  {
    variants: {
      variant: {
        default:
...
>(
  (
    ...
    const toggleOption = (option: string) => {
      const currentSelectedValues = Array.isArray(selectedValues)
        ? selectedValues
        : [];
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border h-7  items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
              className
            )}
          >
